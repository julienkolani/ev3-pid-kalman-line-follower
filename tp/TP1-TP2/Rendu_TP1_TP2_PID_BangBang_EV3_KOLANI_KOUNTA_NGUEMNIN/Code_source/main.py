...
####################################################################################
# Bloc d'importation des bibliothèques nécessaire
####################################################################################
...
class ControlRobot:
    ...
    def adapt_speed_with_obstacle(self, speed, min_distance=200, stop_distance=80, slow_factor=0.5):
        ...
        - Si un obstacle est entre stop_distance et min_distance -> ralenti
        - Sinon -> vitesse roule a vitesse normal
        """
